...
const NewComment: React.FC<NewCommentProps> = ({ text, commentId, isReplyId }) => {
  return (
    text === "reply" ?
    <section className={`bg-white p-4 rounded-md ${commentId === isReplyId ? 'scale-100 opacity-100' : 'scale-0 opacity-0 absolute'} flex justify-between items-start gap-4 w-[600px] mb-2 transition duration-200`}>
