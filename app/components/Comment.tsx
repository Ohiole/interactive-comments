        ...
        comments && comments.map((comment, i) => {
          return (
            <>
              ...
              <section key={i} className='bg-white p-4 rounded-md flex items-start gap-4 w-[600px]'>
                  ...
                  <div className="w-[1px] h-full bg-gray-300"></div>
                  {
                    comment.replies.map((reply, i) => {
                      return (
                          ...
                          <section key={i} className='bg-white p-4 rounded-md flex items-start gap-4 w-[550px]'>
                              <div className="flex flex-col p-2 items-center gap-2 bg-purple-100 rounded-md">
                                  {/* <Image src="/images/icon-plus.svg" alt='plus sign' width={12} height={12} className='num-comments'/> */}
                                  <div className="group">
                                      <svg
                                  ...
                                  <span className='text-purple font-semibold'>{reply.score}</span>
                              ...
                              <div className='w-full'>
                                  <div className='flex justify-between items-center'>
                                      <div className='flex justify-center items-center gap-3'>
                                          <Image src={reply.user.image.png} alt="User Avatar" width={32} height={32} className='rounded-full cursor-pointer' />
                          
                                          <span className="font-semibold text-sm text-gray-500">{reply.user.username}</span>
